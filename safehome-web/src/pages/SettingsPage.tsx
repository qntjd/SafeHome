      ...
      <div className="max-w-2xl mx-auto px-4 py-6 sm:py-8 pb-24 sm:pb-8 flex flex-col gap-6">
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  />
                  {errors.phone && <p className="text-xs mt-1" style={{ color: 'var(--accent-red)' }}>{errors.phone.message ?? '필수 항목'}</p>}
                </div>
              </div>
              <div>
        ...
        <div style={cardStyle}>
          ...
          <div className="flex items-center gap-3 mb-3">
            <label className="text-sm shrink-0" style={{ color: 'var(--text-muted)' }}>반경</label>
            <input
              ...
              className="flex-1"
            />
            <span className="text-sm font-medium w-12 text-right" style={{ color: 'var(--accent-blue)' }}>
              {radius} km
            </span>
          </div>
          <button
            ...
            className="w-full rounded-xl py-2.5 text-sm font-medium transition-all disabled:opacity-50 mb-4"
            style={{ background: 'var(--accent-blue)', color: '#fff' }}
          >
          ...
          {subscriptions.length > 0 && (
            <div className="flex flex-col gap-2 mb-4">
              <p className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>내 구독 목록</p>
              {subscriptions.map((sub) => (
                ...
                >
                  <div>
                    <p className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>{sub.alertType}</p>
                    <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>반경 {sub.radiusKm}km</p>
                  </div>
                  <button
          ...
          {/* 최근 알림 이력 */}
          <p className="text-xs font-medium mb-2" style={{ color: 'var(--text-muted)' }}>최근 재난알림</p>
          {alerts.length === 0 ? (
